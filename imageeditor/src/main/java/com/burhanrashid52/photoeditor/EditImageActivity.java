...
import com.simplecrop.SimpleCropActivity;
...
public class EditImageActivity extends BaseActivity implements OnPhotoEditorListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEditingToolsAdapter = new EditingToolsAdapter(this, getResources().getStringArray(R.array.photo_editor_tools));
    ...
    private void initViews() {
        ...
        if (isEditIntent()) {
            ...
            imgSave.setImageResource(R.drawable.ic_done);
        }
    }
    ...
    private Uri buildFileProviderUri(@NonNull Uri uri) {
        return FileProvider.getUriForFile(this,
                getString(R.string.file_provider_authority, getPackageName()),
                new File(uri.getPath()));
    }

    @SuppressLint("MissingPermission")
    private void saveImage() {
        if (true/*requestPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)*/) {
            showLoading("Saving...");
            File file = new File(FileUtil.getStorageDirectory(getApplicationContext())
                    + File.separator + ""
        ...
        try {
            ...
            mPhotoEditor.saveAsFile(file.getAbsolutePath(), new PhotoEditor.OnSaveListener() {
                ...
                public void onSuccess(@NonNull String imagePath) {
                    ...
                    startActivityForResult(SimpleCropActivity.createIntent(EditImageActivity.this).setData(imageUri), CROP_REQUEST);
                }

                @Override
                public void onFailure(@NonNull Exception exception) {
                    hideLoading();
                    showSnackbar("Failed to prepare Image");
                }
            });
        } catch (IOException e) {
            e.printStackTrace();
